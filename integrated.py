...
# Configuration
GITHUB_DATA_DIR = "./githubdata"  # Directory for GitHub data
FEDERAL_DATA_DIR = "./federal"    # Directory for Federal data
HUGGINGFACE_DATA_DIR = "./huggingface"  # Directory for Hugging Face data
